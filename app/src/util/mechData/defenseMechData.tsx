        ...
        listOfLists: [
          ...
          },
          {
            ...
            bulletPoints: [
              ...
              {
                point:
                  "You can wave dash out of the wall for a quick follow-up.",
              },
            ],
          },
        ],
        ...
        listOfLists: [
          {
            ...
            bulletPoints: [
              {
                point:
                  "Pull back on your stick and boost while holding reverse.",
              },
              {
                point:
                  "Feather boost and air roll to adjust your angle mid-air.",
              },
            ],
          },
          {
